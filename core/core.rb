...
require_relative('declaration/declaration_builder')
...
require_relative('statement/do_while_statement')
require_relative('statement/for_statement')
require_relative('statement/return')

require_relative('function')
require_relative('identifier_table')
require_relative('scope/inner_scope')
require_relative('scope/global_scope')
